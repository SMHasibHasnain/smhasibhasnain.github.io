...
| Interface              | Implementation              | Also Implements                                     | Ordering                     | Duplicates           | Null Allowed                       | Thread Safe     | Fail-Fast Iterator | Performance (avg)         | Legacy/Modern | Typical Use Case                                      |
|------------------------|-----------------------------|-----------------------------------------------------|------------------------------|-----------------------|-------------------------------------|------------------|---------------------|----------------------------|----------------|--------------------------------------------------------|
| `List`                | `ArrayList`                | `RandomAccess`, `Cloneable`, `Serializable`         | Insertion                    | ✅ Yes                | ✅ Yes (multiple nulls)             | ❌ No            | ✅ Yes              | O(1) get, O(n) remove       | Modern         | Fast random access, dynamic array                     |
|                        | `LinkedList`               | `Deque`, `Queue`, `Cloneable`, `Serializable`       | Insertion                    | ✅ Yes                | ✅ Yes                               | ❌ No            | ✅ Yes              | O(1) add/remove at ends     | Modern         | Frequent insertions/deletions                         |
|                        | `Vector`                   | `RandomAccess`, `Cloneable`, `Serializable`         | Insertion                    | ✅ Yes                | ✅ Yes                               | ✅ Yes           | ✅ Yes              | O(1) get (synchronized)     | Legacy         | Thread-safe dynamic array (legacy)                   |
|                        | `Stack`                    | extends `Vector`                                    | LIFO                         | ✅ Yes                | ✅ Yes                               | ✅ Yes           | ✅ Yes              | O(1) push/pop               | Legacy         | Stack-based LIFO data structure                       |
| `Set`                 | `HashSet`                  | `Set`, `Cloneable`, `Serializable`                  | Unordered                    | ❌ No                 | ✅ Yes (one null)                   | ❌ No            | ✅ Yes              | O(1) add/remove             | Modern         | Fast unique elements                                 |
|                        | `LinkedHashSet`            | extends `HashSet`                                   | Insertion                    | ❌ No                 | ✅ Yes                               | ❌ No            | ✅ Yes              | O(1) add/remove             | Modern         | Ordered unique items                                  |
|                        | `TreeSet`                  | `NavigableSet`, `SortedSet`,<br> `Cloneable`, `Serializable` | Sorted (natural or custom) | ❌ No                 | ❌ No                                | ❌ No            | ✅ Yes              | O(log n) ops                | Modern         | Sorted unique elements                                |
|                        | `CopyOnWriteArraySet`      | `Set`, `Serializable`                               | Insertion                    | ❌ No                 | ✅ Yes                               | ✅ Yes           | ❌ No               | O(n) write, O(1) read       | Modern         | Read-heavy concurrent sets                           |
|                        | `ConcurrentSkipListSet`    | `NavigableSet`, `SortedSet`, `Serializable`         | Sorted                       | ❌ No                 | ❌ No                                | ✅ Yes           | ❌ No               | O(log n) concurrent ops      | Modern         | Sorted concurrent set                                |
| `Queue`               | `PriorityQueue`            | `Serializable`                                      | Priority order               | ✅ Yes                | ✅ Yes                               | ❌ No            | ✅ Yes              | O(log n) insertion          | Modern         | Priority-based queue                                 |
|                        | `ArrayDeque`               | `Deque`, `Cloneable`, `Serializable`                | Insertion                    | ✅ Yes                | ❌ No                                | ❌ No            | ✅ Yes              | O(1) ends insert/remove      | Modern         | Efficient deque operations                            |
|                        | `LinkedList`               | `Deque`, `Queue`                                    | Insertion                    | ✅ Yes                | ✅ Yes                               | ❌ No            | ✅ Yes              | O(1) ends insert/remove      | Modern         | Queue/deque + list features                          |
|                        | `LinkedBlockingQueue`      | `BlockingQueue`, `Serializable`                     | FIFO                         | ✅ Yes                | ✅ Yes                               | ✅ Yes           | ❌ No               | O(1) ops                    | Modern         | Producer-consumer queues                             |
|                        | `ArrayBlockingQueue`       | `BlockingQueue`, `Serializable`                     | FIFO                         | ✅ Yes                | ❌ No                                | ✅ Yes           | ❌ No               | O(1) ops                    | Modern         | Bounded blocking queue                               |
|                        | `DelayQueue`               | `BlockingQueue`, `Serializable`                     | Delayed order                | ✅ Yes                | ❌ No                                | ✅ Yes           | ❌ No               | O(log n)                    | Modern         | Scheduled task queue                                |
|                        | `SynchronousQueue`         | `BlockingQueue`, `Serializable`                     | N/A (hand-off)               | ✅ Yes                | ❌ No                                | ✅ Yes           | ❌ No               | O(1)                        | Modern         | Direct handoff between threads                       |
|                        | `PriorityBlockingQueue`    | `BlockingQueue`, `Serializable`                     | Priority                     | ✅ Yes                | ❌ No                                | ✅ Yes           | ❌ No               | O(log n)                    | Modern         | Priority concurrent queue                            |
|                        | `LinkedTransferQueue`      | `TransferQueue`, `BlockingQueue`, <br> `Serializable`    | FIFO                         | ✅ Yes                | ✅ Yes                               | ✅ Yes           | ❌ No               | O(1)                       | Modern         | Transfer queue with optional waiting                 |
| `Deque`               | `ArrayDeque`               | `Deque`, `Cloneable`, `Serializable`                | Insertion                    | ✅ Yes                | ❌ No                                | ❌ No            | ✅ Yes              | O(1) ends ops               | Modern         | Double-ended queue                                   |
|                        | `LinkedBlockingDeque`      | `BlockingDeque`, `Serializable`                     | Insertion                    | ✅ Yes                | ✅ Yes                               | ✅ Yes           | ❌ No               | O(1)                       | Modern         | Thread-safe deque                                     |
| `Map`                 | `HashMap`                  | `Map`, `Cloneable`, `Serializable`                  | Unordered                    | ❌ Keys: No<br>✅ Values: Yes | ✅ 1 null key, multiple null values | ❌ No            | ✅ Yes              | O(1)                        | Modern         | General-purpose key-value map                        |
|                        | `LinkedHashMap`            | extends `HashMap`                                   | Insertion                    | ❌ No                 | ✅ Yes                               | ❌ No            | ✅ Yes              | O(1)                        | Modern         | Maintains insertion order                            |
|                        | `TreeMap`                  | `NavigableMap`, `SortedMap`,<br> `Cloneable`, `Serializable` | Sorted                  | ❌ No                 | ❌ No                                | ❌ No            | ✅ Yes              | O(log n)                    | Modern         | Sorted key-value pairs                               |
|                        | `Hashtable`                | `Map`, `Cloneable`, `Serializable`                  | Unordered                    | ❌ No                 | ❌ No                                | ✅ Yes           | ✅ Yes              | O(1) (sync)                 | Legacy         | Legacy thread-safe map                               |
|                        | `ConcurrentHashMap`        | `ConcurrentMap`, `Serializable`                     | Unordered                    | ❌ No                 | ❌ No                                | ✅ Yes           | ❌ No               | O(1)                        | Modern         | High-performance concurrent map                      |
|                        | `EnumMap`                  | `Map`, `Serializable`, `Cloneable`                  | Natural enum order           | ❌ No                 | ✅ Null values only                 | ❌ No            | ✅ Yes              | O(1)                        | Modern         | Keys must be enum type                              |
|                        | `WeakHashMap`              | `Map`                                               | Unordered                    | ❌ No                 | ✅ Yes                               | ❌ No            | ✅ Yes              | O(1)                        | Modern         | Auto-removal when keys GC’d                         |
|                        | `IdentityHashMap`          | `Map`, `Serializable`, `Cloneable`                  | Unordered                    | ❌ No                 | ✅ Yes                               | ❌ No            | ✅ Yes              | O(1)                        | Modern         | Uses `==` instead of `equals()`                     |
| `ConcurrentMap`        | `ConcurrentHashMap`        | `Map`, `Serializable`                               | Unordered                    | ❌ No                 | ❌ No                                | ✅ Yes           | ❌ No               | O(1)                        | Modern         | High-perf concurrent map                            |
| `ConcurrentNavigableMap`| `ConcurrentSkipListMap`  | `NavigableMap`, `SortedMap`                         | Sorted                       | ❌ No                 | ❌ No                                | ✅ Yes           | ❌ No               | O(log n)                    | Modern         | Thread-safe sorted map                              |
| `SortedSet`           | `TreeSet`                  | `NavigableSet`, `Set`                               | Sorted                       | ❌ No                 | ❌ No                                | ❌ No            | ✅ Yes              | O(log n)                    | Modern         | Sorted unique set                                   |
| `NavigableSet`        | `TreeSet`,<br> `ConcurrentSkipListSet` |                                             | Sorted                       | ❌ No                 | ❌ No                                | ❌ / ✅          | ✅ / ❌            | O(log n)                    | Modern         | Range queries on sorted sets                        |
| `SortedMap`           | `TreeMap`                  | `Map`                                               | Sorted                       | ❌ No                 | ❌ No                                | ❌ No            | ✅ Yes              | O(log n)                    | Modern         | Sorted key-value mapping                            |
| `Dictionary`          | `Hashtable`                | -                                                   | Unordered                    | ❌ No                 | ❌ No                                | ✅ Yes           | ✅ Yes              | O(1)                        | Legacy         | Legacy key-value structure                          |
